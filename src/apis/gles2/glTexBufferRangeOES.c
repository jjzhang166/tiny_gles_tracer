...
glTexBufferRangeOES (GLenum target, GLenum internalformat, GLuint buffer, GLintptr offset, GLsizeiptr size)
{
    ...
    glTexBufferRangeOES_ (target, internalformat, buffer, offset, size);

    fprintf (g_log_fp, "glTexBufferRangeOES(%s, %s, %d, %ld, %ld);\n",
