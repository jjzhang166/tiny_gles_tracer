...
#define glGetTexParameterfv_   \
    ((void (*)(GLenum target, GLenum pname, GLfloat *params))  \
    GLES_ENTRY_PTR(glGetTexParameterfv_Idx))

#define glGetTexParameteriv_   \
    ((void (*)(GLenum target, GLenum pname, GLint *params))  \
    GLES_ENTRY_PTR(glGetTexParameteriv_Idx))
...
glGetTexParameterfv (GLenum target, GLenum pname, GLfloat *params)
{
    ...
    fprintf (g_log_fp, "glGetTexParameterfv(%s, %s, %p);", 
...
glGetTexParameteriv (GLenum target, GLenum pname, GLint *params)
{
    ...
    fprintf (g_log_fp, "glGetTexParameteriv(%s, %s, %p);", 
             get_target_str (target),
             get_pname_str (pname), params);
