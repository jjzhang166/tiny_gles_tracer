...
#define glTexImage2D_   \
    ...
    GLES_ENTRY_PTR(glTexImage2D_Idx))
              ...
              GLint border, GLenum format, GLenum type, const void *pixels)
{
    ...
    fprintf (g_log_fp, "glTexImage2D(%s, %d, %s, %d, %d, %d, %s, %s, %p);",
    ...
    {
        char fname[128];
        snprintf (fname, sizeof(fname), "%05d_glTexImage2D_%05d.tga", g_pid, s_count);
