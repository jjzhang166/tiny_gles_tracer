...
#define glTexSubImage3D_   \
    ...
    GLES_ENTRY_PTR(glTexSubImage3D_Idx))


GL_APICALL void GL_APIENTRY
glTexSubImage3D (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, 
                 GLsizei depth, GLenum format, GLenum type, const void *pixels)
{
    ...
    fprintf (g_log_fp, "glTexSubImage3D(%s, %d, %d, %d, %d, %d, %d, %d, %s, %s, %p);",
