...
#define glDrawRangeElements_         \
    ...
    GLES_ENTRY_PTR(glDrawRangeElements_Idx))
...
glDrawRangeElements (GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const void *indices)
{
    ...
    fprintf (g_log_fp, "glDrawRangeElements(%s, %d, %d, %d, %s, %p); // ",
    ...
    {
        char fname[128];
        snprintf (fname, sizeof(fname), "%05d_glDrawRangeElements_%05d_%05d.tga", g_pid, g_frame_counter, g_draw_counter);
