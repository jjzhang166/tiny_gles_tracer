...
#define glRenderbufferStorageMultisample_   \
    ((void (*)(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height)) \
    GLES_ENTRY_PTR(glRenderbufferStorageMultisample_Idx))
...
glRenderbufferStorageMultisample (GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height)
{
    ...
    glRenderbufferStorageMultisample_ (target, samples, internalformat, width, height);

    fprintf (g_log_fp, "glRenderbufferStorageMultisample(%s, %d, %s, %d, %d);\n",
             get_target_str (target), samples,
