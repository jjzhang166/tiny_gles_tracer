...
#define glGetBufferPointervOES_   \
    ((void (*)(GLenum target, GLenum pname, void **params))  \
    GLES_ENTRY_PTR(glGetBufferPointervOES_Idx))
...
glGetBufferPointervOES (GLenum target, GLenum pname, void **params)
{
    ...
    glGetBufferPointervOES_ (target, pname, params);

    fprintf (g_log_fp, "glGetBufferPointervOES(%s, %s, %p);\n",
