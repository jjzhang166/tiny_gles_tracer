...
#define eglCreatePbufferSurface_  \
    ((EGLSurface (*)(EGLDisplay dpy, EGLConfig config, const EGLint *attrib_list))  \
    EGL_ENTRY_PTR(eglCreatePbufferSurface_Idx))
...
eglCreatePbufferSurface (EGLDisplay dpy, EGLConfig config, const EGLint *attrib_list)
{
    ...
    fprintf (g_log_fp, "eglCreatePbufferSurface(%p, %p, %p);", dpy, config, attrib_list);
    ...
    if (eglCreatePbufferSurface_)
    {
        sfc = eglCreatePbufferSurface_ (dpy, config, attrib_list);
